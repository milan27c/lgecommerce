...
export function EnergyForecast({
  ...
  if (!forecast) {
    return (
      <div className="flex min-h-90 flex-1 flex-col items-center justify-center rounded-eco border border-dashed border-neutral-300 bg-neutral-50 px-6 py-14 text-center">
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-eco border border-eco-200 bg-eco-50 p-5">
      ...
      <p
        role="status"
        className="flex items-start gap-3 rounded-eco bg-ink-900 px-5 py-4 text-body text-ink-100 sm:items-center"
      >
