...
export function TrustBar() {
  return (
    <section aria-labelledby="trust-bar-heading" className="relative z-10 mt-6 lg:-mt-6">
      ...
      <Container>
        <ul className="grid list-none grid-cols-2 gap-px overflow-hidden rounded-card border border-neutral-200 bg-neutral-200 shadow-sm lg:grid-cols-4">
            ...
            return (
              <Reveal key={item.id} as="li" index={index} className="bg-white">
                <div className="flex items-center gap-3 p-4 lg:p-5">
                  <span className="grid size-10 shrink-0 place-items-center rounded-control bg-accent-50 text-accent-600">
