...
const cell =
  "grid h-10 min-w-10 place-items-center rounded-control border px-3 text-body transition-colors dur-fast ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2";
